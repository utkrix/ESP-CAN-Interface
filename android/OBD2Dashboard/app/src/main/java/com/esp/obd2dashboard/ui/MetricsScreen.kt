...
fun MetricsScreen(viewModel: ObdViewModel) {
        ...
        Column(
                ...
                MetricRow(
                        "Intake Air Temp",
                        metrics.iatC?.format(0),
                        "°C",
                        getSupport(metrics, ObdPid.IAT)
                )
                MetricRow(
                        "Ambient Temp",
                        metrics.ambientTempC?.format(0),
                        "°C",
                        getSupport(metrics, ObdPid.AMBIENT_TEMP)
                )
                MetricRow(
                        "Engine Load",
                ...
                MetricRow(
                        "Fuel Consumption",
                        metrics.fuelConsumptionLPer100km?.format(1),
                        "L/100km",
                        true
                )
                ...
                MetricRow(
                        "BARO",
                        metrics.baroKpa?.format(0),
                        "kPa",
                        getSupport(metrics, ObdPid.BARO)
                )
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                        ...
                        Row(
                                ...
                                Text(
                                        ...
                                        color = Color.White.copy(alpha = 0.8f),
                                        modifier =
                                                Modifier.align(androidx.compose.ui.Alignment.Bottom)
                                )
                        }
                }
        }
